...
$_maildomain = '@grundfos.com';	# Example @ibm.com. Use this if the user's email is equal to login with this value appeneded.
...
$_smtpserver = 'message.grundfos.com:2025'; # SMTP server name and port
$_fromadress = 'flemmingsorensen@grundfos.com'; # CC administrator email
$_ccadmin_name = 'Flemming Sørensen';
...
($_warnofquarantine = <<ENDWARNQ) =~ s/^\s+//gm;
  ...
  You can get a quarantined view back by running the appropiate RevokeView job from http://dkclearp05.emea.group.grundfos.com:8080/view/Get My View Back/
...
($_warnsummary = <<ENDSUMWARN)  =~ s/^\s+//gm;
	...
	owners have been notified, that they can get a quarantined views back by running the appropiate 
	RevokeView job from http://dkclearp05.emea.group.grundfos.com:8080/view/Get My View Back/
